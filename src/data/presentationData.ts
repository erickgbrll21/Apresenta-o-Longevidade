...
export const HERO_KPIS = [
  {
    count: { to: 2.5, prefix: "R$ ", suffix: " bi", decimals: 1, decimalSeparator: "," },
...
export const DEPOIMENTOS = [
  ...
  {
    quote:
      "Centralizar benefícios, saúde e RH num único parceiro mudou a rotina do nosso time. Ganhamos agilidade, previsibilidade e uma experiência melhor para os colaboradores — sem custo extra para a empresa.",
